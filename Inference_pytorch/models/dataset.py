...
def get_imagenet(batch_size, data_root='/root/neurosim/imagenet', train=True, val=True, **kwargs):
    # data_root = data_root
    num_workers = kwargs.setdefault('num_workers', 1)
    ...
    if train:
        ...
        train_path = os.path.join(data_root, 'train.X1')
    ...
    if val:
        ...
        val_path = os.path.join(data_root, 'val.X')
